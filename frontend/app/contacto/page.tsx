        ...
        <section className="bg-blue-50 py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-blue-600">Entre em Contacto</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row gap-12">
                  ...
                  <CardContent className="pt-6">
                    <form className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea id="mensagem" placeholder="A sua mensagem" className="min-h-32" />
                      </div>
              ...
              <div className="md:w-1/2">
                <h2 className="text-3xl font-bold mb-6 text-blue-600">Informações de Contacto</h2>
