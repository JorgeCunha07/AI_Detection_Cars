...
def evaluate_answer(question, user_answer):
    """
    Monta o prompt com a pergunta e a resposta, 
    e gera a avaliação com a instrução para retornar apenas "Correto" ou "Incorreto".
    """
    prompt = (
        f"Pergunta: {question}\n"
    ...
    # Limitar a saída para poucos tokens após o prompt (ajuste +2 para tentar restringir ainda mais)
